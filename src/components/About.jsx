...
const About = () => {
  ...
  return (
    <>
      <section id="about" className="min-h-screen flex items-center justify-center py-16 bg-white pt-24 md:pt-16">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-base text-gray-600 leading-relaxed max-w-xl">
                I enjoy the challenge of turning complex business problems into elegant technical solutions. Whether it's automating workflows or designing AI-powered applications using intellgent LLM models, I'm passionate about building systems that are both powerful and practical.
              </p>
